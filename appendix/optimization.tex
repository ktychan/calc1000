...
\begin{frame}[t]
  ...
  \[
    T = \frac{\color{warn} 2 - \sqrt{s^{2} - 1}}{6} + \frac{s}{3}, \text{ on domain } 1 \le s \le \sqrt{5}.
  \]
...
\begin{frame}[t]
  \onslide<2->{
    ...
    \[
      T(w) = \frac{w}{6} + \frac{\sqrt{(2-w)^{2} + 1}}{3}, \text{ on domain } 0 \le w \le 2,
    \]
  ...
  \[
    T(s) = \frac{2 - \sqrt{s^{2} - 1}}{6} + \frac{s}{3}, \text{ on domain } 1 \le s \le \sqrt{5}.
  \]
  \onslide<2->{or
    \[
      T(w) = \frac{w}{6} + \frac{\sqrt{(2-w)^{2} + 1}}{3}, \text{ on domain } 0 \le w \le 2.
