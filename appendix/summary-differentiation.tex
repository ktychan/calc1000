...
\faExclamationTriangle{} We are expected to \hlmain{remember and apply} these formulas to solve problems involving derivatives during the midterm test and the final exam. There \hlwarn{will not} be a formula sheet.
