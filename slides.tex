...
\begin{poll}
  Are you convinced?
  \[
    L = \lim_{x \to 0} \frac{1}{x} + \frac{5}{x(x-5)} = \lim_{x \to 0} \frac{1}{x} + \lim_{x \to 0} \frac{5}{x(x-5)} = \text{DNE} + \infty = \infty.
  \]
...
\begin{poll}
  ...
  \[
    L = \lim_{x \to 0} \frac{1}{x} + \frac{5}{x(x-5)} \quad=\quad \frac{1}{0} + \frac{5}{0(-5)} \quad=\quad \frac{1}{0} - \frac{1}{0} \quad=\quad 0.
  \]

  \begin{minipage}{.5\textwidth}
    \begin{enumerate}
      \item Seems fine.
      \item Looks sketchy. \onslide<2->{\hlmain{\faCheck{}}}
      \item 
      \item 
      \item I am not sure.
    \end{enumerate}
