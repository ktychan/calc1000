...
\begin{frame}
  Can we use use implicit differentiation to find the slope of \(y^{2} + x^{2} = 1\) at the point \((5,5)\)?
...
\begin{frame}
  Can the inverse function theorem be deduced using implicit differentiation?
...
\begin{frame}
  How you assess your learning progress?
