...
\begin{lesson}{The Net Change Theorem}
  ...
  Let's change the question ever so slightly from \hlwarn{net} displacement to \hlwarn{total} displacement. The Net Change Theorem still applies, but it requires a slightly adjustment using our geometric interpretation of area.
  \begin{example}
