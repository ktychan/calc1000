...
\begin{document} \section{Applied optimization problems}
  ...
  \begin{example} \label{ex:optimization-swim}
    ...
    \begin{tikzpicture}[scale=2]
      ...
      \draw[teal, domain=0.2:1.8, smooth, samples=100] plot ({\x},{sin(4*pi*\x)*0.05+0.75});
      \draw[teal, domain=0.2:1.8, smooth, samples=100] plot ({\x},{sin(4*pi*\x)*0.051+0.50});
      \draw[teal, domain=0.2:1.8, smooth, samples=100] plot ({\x},{sin(4*pi*\x)*0.051+0.25});
    \end{tikzpicture}
