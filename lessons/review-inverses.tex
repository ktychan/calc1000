...
This definition is actually very useful. This definition \emph{alone} tells us how to
...
We skip the trial-and-error part of the story and go straight to the insight: Let's pretend \(f(x)\) has an inverse and denote \underline{\hspace{2in}}. The definition now gives us a useful equation. \updatenote{"an useful" corrected to "a useful".}
...
\begin{exercise}
  Let \(f(x) = x^{2}\) on domain \((-\infty, 0]\). Its inverse is \(-\sqrt{x}\) on domain \([0, \infty)\). One can explain this phenomenon using a graph, the definition and an appropriate equivalent equation. 
...
\begin{exercise} \label{ex:trig-cos-arcsin}
