...
Example~\ref{ex:limit-riemann} is an example of calculations when we evaluate definite integrals from their definitions. 

\begin{exercise} \label{ex:limit-riemann}
