...
The Sigma notation is a compact way to express the sum of a bunch of numbers and appears frequently in science. 
...
When we need to express a sum using the Sigma notation, remember that the index of summation, say \(i\), \hlwarn{must be an integer and increases by exactly \(1\)}. Look for a pattern of change across the summands and express such pattern as a multiple of \(i\).
...
\begin{exercise}
  Express the following sum \(A\) using the Sigma notation. 
  \[
