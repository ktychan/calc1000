...
We briefly talked about it on page~\pageref{ex:piecewise-abs-of-function}. Here are some examples from sciences and business.
\begin{itemize}
...
\faStar{} A key \hlmain{idea} to deal with all such problems is to \hlmain{set up one or more equations involving the unknowns that satisfy the given properties}. 
\begin{enumerate}
