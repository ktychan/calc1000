...
\begin{example}
  The second derivative of a function is denoted as \(f''(x)\) or \(f^{(2)}(x)\) or \(\frac{d^{2}}{dx^{2}} f(x)\).

  The third derivative of a function is denoted as \(f'''(x)\) or \(f^{(3)}(x)\) or \(\frac{d^{3}}{dx^{3}} f(x)\).
\end{example}
...
\begin{exercise}
  ...
  \[
    \sqrt{1 - x^{2}}, \qquad (4x^{2} + x - 1)^{3/2}, \qquad e^{-x}, \qquad x^{x}
  \]
