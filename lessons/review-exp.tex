...
\begin{exercise} \label{ex:exp-change-exercise-2}
  ...
  \begin{enumerate}[wide, label={Method (\arabic*).}]
    ...
    \item Perform a change of variable \(u = 2x\) and use the property of continuous functions.  This methods is fast but requires us to recognize \(e\) from the limit stated on page~\ref{def:exp-ln}.
