...
\begin{lesson}{The Substitution Rule}
  ...
  Strategy for choosing \(u\): Find a \hlmain{pair} of functions related by differentiations and choose \(u\) to be the derivative.  Sometimes, there are more than one choices for \(u\).
  \begin{example}
