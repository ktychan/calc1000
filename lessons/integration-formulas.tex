...
\begin{document} \section{Integration formulas and properties} \label{lesson:integration-formulas}
...
{\footnotesize \faExclamationTriangle{} The restriction \hlwarn{\(n \ne -1\)} on the second line \hlwarn{applies to the entire line}.}

\bigskip
\textbf{Properties of definite and indefinite integrals}. 
\begin{align*}
