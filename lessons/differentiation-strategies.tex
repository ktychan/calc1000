...
\begin{document} \section{More general problem-solving}
Let's see how our knowledge of limits, continuity and derivatives are connected and how to use them in various situations.


\faStar{} Pro-tip: Allow the Leibniz notation \(\frac{d}{dx} \cdots\) to guide you to the next step!
\begin{example}
...
\begin{exercise}
  Find \(x\) at which \(\frac{d^{3}}{dx^{3}} \sin(x)\) has a horizontal tangent line. 
