...
\begin{thm}
  Suppose \(f(x)\) is a differentiable function and I is an interval.

  \begin{enumerate}[label=(\alph*)]
    \item If \(f'(x) > 0\) for every \(x\) in \(I\), then \(f(x)\) is strictly increasing on \(I\).
    \item If \(f'(x) < 0\) for every \(x\) in \(I\), then \(f(x)\) is strictly decreasing on \(I\).
  \end{enumerate}
\end{thm}
