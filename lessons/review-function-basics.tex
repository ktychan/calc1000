    ...
    \begin{minipage}[c]{2.6in}
      \begin{tikzpicture}[scale=1]
        \begin{axis}[
          ...
          \addplot[thick, domain=-2:2] {2*x + 1};
          \node[above left] at (axis cs:1,3) {\(L\)};
        \end{axis}
      \end{tikzpicture}
    \end{minipage}
  ...
  \begin{example}
    ...
    \begin{tikzpicture}[scale=1]
      \begin{axis}[
        ...
        \addplot[thick, domain={-5}:5] {atan(x)} node[below] {\(\arctan(x)\)};
      \end{axis}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}[scale=1]
      \begin{axis}[
        ...
        % \addplot[thick, domain={-5}:5] {atan(x)};
      \end{axis}
    \end{tikzpicture}
  \end{example}
