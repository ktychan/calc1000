...
\begin{document} \section{Review of trigonometric functions}
  ...
  \begin{example}
    ...
    \begin{center}
      \includegraphics[page=1]{../standalones/build/plot-trigs}
      \hspace{0.5in}
      \includegraphics[page=2]{../standalones/build/plot-trigs}
    \end{center}
    \vfill{}

    \begin{center}
      \includegraphics[page=3]{../standalones/build/plot-trigs}
      \hspace{0.5in}
      \includegraphics[page=4]{../standalones/build/plot-trigs}
    \end{center}
    \vfill{}

    \begin{center}
      \includegraphics[page=5]{../standalones/build/plot-trigs}
      \hspace{0.5in}
      \includegraphics[page=5]{../standalones/build/plot-trigs}
    \end{center}
    \vfill{}
