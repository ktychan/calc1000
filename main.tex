...
\makeatletter
\def\input@path{{guidednotes/}}
\makeatother
\documentclass{guidednotes}

\setcourse{Calculus}{Calc}{1000A}{Calculus I}{}
\setterm{Fall}{2025}
\setauthor{Kelvin Chan}{K. Chan}
\setinstitute{University of Western Ontario}
...
% \newenvironment{solution}{\color{gray}\small \textbf{Sample solution}.}{\par\bigskip\color{black}\normalsize}
\begin{document}
...
\begin{week}{December 8 and 9} % review
